 ...
 * Politics Feeds MCP.
 *
 * Politics & policy — US political news, commentary and analysis across the spectrum.
...
const PACK_LABEL = 'Politics Feeds';
...
const FEEDS: Record<string, FeedDef> = {
  'the-bulwark': { title: "The Bulwark", url: "https://www.thebulwark.com/feed", category: "politics", source: "The Bulwark", description: "Center-right US politics & commentary." },
  'mother-jones': { title: "Mother Jones", url: "https://www.motherjones.com/feed/", category: "politics", source: "Mother Jones", description: "Investigative & political reporting." },
  reason: { title: "Reason", url: "https://www.reason.com/feed/", category: "politics", source: "Reason", description: "Libertarian politics & policy." },
  rollcall: { title: "Roll Call", url: "https://www.rollcall.com/feed/", category: "politics", source: "Roll Call", description: "Capitol Hill news." },
  'washington-monthly': { title: "Washington Monthly", url: "https://washingtonmonthly.com/feed/", category: "politics", source: "Washington Monthly", description: "US politics & policy." },
  'the-american-conservative': { title: "The American Conservative", url: "https://www.theamericanconservative.com/feed/", category: "politics", source: "The American Conservative", description: "Right-of-center politics." },
  jacobin: { title: "Jacobin", url: "https://jacobin.com/feed/", category: "politics", source: "Jacobin", description: "Left politics & policy." },
};

const tools: McpToolExport['tools'] = [
  {
    name: 'list_feeds',
    description: 'List the curated politics & policy feeds (id, title, category, source). Optionally filter by category (politics) or keyword. Pass an id to read_feed.',
    inputSchema: {
      type: 'object',
      properties: {
        category: { type: 'string', description: 'Filter by category: politics.' },
  ...
  {
    name: 'read_feed',
    description: 'Read a curated politics & policy feed by its id (from list_feeds). Returns normalized items (title, link, published, summary). Optionally filter items by keyword.',
    inputSchema: {
      type: 'object',
      properties: {
